...
function BookFooter(props) {
    ...
    return (
        <footer id={"bottom_bar"} className={"p-2 border-top d-flex flex-row align-items-center"}>
            <button className={"bottom_bar_hover btn-normal btn btn-outline-secondary"} onClick={left}>
            ...
            <button className={"bottom_bar_hover btn-normal btn btn-outline-secondary"} onClick={right}>
